...
public interface HashMapInterface<K, V> {
     ...
     * post-condition: If the key does not exist, it is added to the map with the associated value.
     ...
     * <p>ADT Spec: <br>
     * pre-condition: The map may or may not contain the specified key.<br>
     * post-condition: The map remains unchanged. Returns the value associated with the key if it exists,
     ...
     * post-condition: The value associated with the key is updated to the new value.
     * Throws a NoSuchElementException if the key does not exist.
     * 
     ...
     * <p>ADT Spec: <br>
     * pre-condition: The map may or may not contain the specified key.<br>
     * post-condition: If the key exists, the key-value pair is removed from the map. 
     ...
     * <p>ADT Spec: <br>
     * pre-condition: The map may or may not contain the specified key.<br>
     * post-condition: The map remains unchanged. Returns true if the key is present,
     ...
     * post-condition: The map remains unchanged. Returns the total number of key-value pairs in the map.
     * 
     ...
     * <p>ADT Spec: <br>
     * pre-condition: The map may contain zero or more key-value pairs.<br>
     * post-condition: The map remains unchanged. Returns true if the map is empty,
     * otherwise returns false.
     * 
     ...
     * <p>ADT Spec: <br>
     * pre-condition: The map may contain zero or more key-value pairs.<br>
     * post-condition: The map remains unchanged. Returns an iterator that provides sequential 
     * access to the keys in the map.
     * 
